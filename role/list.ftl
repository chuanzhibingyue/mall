             ...
             [#list page.content as role]
                 <tr class="hover">
		             ...
		             <td class="w150 align-center">
		               <a href="">${message("nc_edit")}</a> | <a href="javascript:void(0)" onclick="if(confirm('${message("gadmin_del_confirm")}')){location.href=''}">${message("admin_index_del_admin")}</a>
		            </td>
